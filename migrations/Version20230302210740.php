 ...
 */
final class Version20230302210740 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE budget DROP date_enregistrement');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE budget ADD date_enregistrement DATETIME NOT NULL');
    }
}
