...
class ServiceController extends AbstractController
{
    ...
    public function add(\Doctrine\Persistence\ManagerRegistry $doctrine, Request $req): Response {
    ...
    public function deleteSpeciality(\Doctrine\Persistence\ManagerRegistry $doctrine, $id): Response
    {
        $em= $doctrine->getManager();
    ...
    public function updateService(\Doctrine\Persistence\ManagerRegistry $doctrine, $id, Request $req): Response {
        $em = $doctrine->getManager();
